...
public class WebRTCClient {
    ...
    private void initPeerConnectionFactory() {
        ...
        Log.d("TAG","in initPeerConnedtion Factory");
    }
    ...
    private PeerConnectionFactory createPeerConnectionFactory() {
        ...
        Log.d("TAG","in createPeerConnectionFactory ");
    ...
    private PeerConnection createPeerConnection(PeerConnection.Observer observer){
        Log.d("TAG","in createPeeronnection");
                    ...
                    peerConnection.setLocalDescription(new SdpObserver(){
                        ...
                        public void onSetSuccess() {
                            ...
                            if (listener!=null){
                                ...
                                Log.d("TAG","created offer andsending to other peer");
                            }
                        }
                    },sessionDescription);
                }
                    ...
                    peerConnection.setLocalDescription(new SdpObserver(){
                        ...
                        public void onSetSuccess() {
                            ...
                            if (listener!=null){
                                ...
                                Log.d("TAG","create answer and sending to another peer");
                            }
                        }
                    },sessionDescription);
                }
    ...
    public void onRemoteSessionReceived(SessionDescription sessionDescription){
        ...
        Log.d("TAG","in onRemote session received");
    }

    public void addIceCandidate(IceCandidate iceCandidate){
        peerConnection.addIceCandidate(iceCandidate);
        Log.d("TAG","in add ice candiddate");
    }
    ...
    public void sendIceCandidate(IceCandidate iceCandidate, String target){
        ...
        if (listener!=null){
            ...
            Log.d("TAG","in send ice candiddate adding and sending to anoter peer");
        }
    }
